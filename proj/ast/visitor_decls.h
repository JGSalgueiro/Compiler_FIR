...
#include <cdk/ast/visitor_decls.h>
  ...
  virtual void do_left_index_node(fir::left_index_node *const node, int lvl) = 0;
  virtual void do_memory_node(fir::memory_node *const node, int lvl) = 0;
  ...
  void do_left_index_node(fir::left_index_node *const node, int lvl);
  void do_memory_node(fir::memory_node *const node, int lvl);
